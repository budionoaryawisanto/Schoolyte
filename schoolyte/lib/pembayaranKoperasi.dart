...
class PembayaranKoperasi extends StatefulWidget {
  @override
  _PembayaranKoperasiState createState() => new _PembayaranKoperasiState();
}

class _PembayaranKoperasiState extends State<PembayaranKoperasi> {
  List<Test> _list = [];
  List<Test> _kantin = [];
  var loading = false;
