...
class PembayaranSeragam extends StatefulWidget {
  @override
  _PembayaranSeragamState createState() => new _PembayaranSeragamState();
}

class _PembayaranSeragamState extends State<PembayaranSeragam> {
  List<Test> _payUniform = [];
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        for (Map<String, dynamic> i in data) {
          _payUniform.add(Test.formJson(i));
          loading = false;
        }
      });
    }
                        ...
                        child: GridView.builder(
                            ...
                            itemBuilder: (context, i) {
                              ...
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(7),
                                  color: Color.fromRGBO(243, 243, 243, 0.60),
                                ),
                                child: Column(
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceEvenly,
