...
class _JadwalAdminPageState extends State<JadwalAdminPage> {
  ...
  navigasiGuru() {
    if (statusUser.toLowerCase() == 'dinas pendidikan') {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => DetailJadwalAdminGuru()));
    } else {
      return;
    }
  }
  ...
  navigasiSiswa() {
    if (statusUser.toLowerCase() == 'admin' ||
        statusUser.toLowerCase() == 'dinas pendidikan' ||
        statusUser.toLowerCase() == 'pegawai tu') {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => DetailJadwalAdminKelas()));
    } else {
      return;
    }
  }
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          DrawerHeader(
                            ...
                            child: Image(
                              image:
                                  AssetImage('assets/images/logolanding.png'),
                            ),
                          ),
                          ListTile(
                            leading: Icon(
